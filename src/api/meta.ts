...
export const mysqlMeta = {
  ...
  functions: (id: string, database?: string) => get<{ functions: any[] }>(`/meta/mysql/${id}/functions`, { database }),
  events: (id: string, database?: string) => get<{ events: any[] }>(`/meta/mysql/${id}/events`, { database }),
